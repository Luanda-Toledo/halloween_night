...
from personajes.enemigo import Enemy
from plataforma.pantalla_principal import Plataform
from halloween_nigth.menu.background import Background
from halloween_nigth.menu.bullet import Bullet
...
class FormGameLevel1(Form):
    def __init__(self, name, master_surface, x, y, w, h, color_background, color_border, active):
        ...
        self.boton1 = Button(master = self, x = 0, y = 0, w = 140, h = 50, color_background = None, color_border = None,
                            ...
                            on_click = self.on_click_boton1, on_click_param = "form_menu_B", text = "BACK",
        ...
        self.boton2 = Button(master = self, x = 200, y = 0, w = 140, h = 50, color_background = None, color_border = None,
                            image_background = "halloween_nigth/recursos/objetos_pantalla/boton.jpeg",
                            on_click = self.on_click_boton1, on_click_param = "form_menu_B", text = "PAUSE",
                            font="Verdana", font_size = 30, font_color = C_WHITE)
        
        self.boton_shoot = Button(master = self, x = 400, y = 0, w = 140, h = 50, color_background = None, color_border = None,
                                image_background = "halloween_nigth/recursos/objetos_pantalla/boton.jpeg",
                                on_click = self.on_click_shoot, on_click_param = "form_menu_B", text = "SHOOT", 
                                font = "Verdana", font_size = 30, font_color = C_WHITE)
       
        self.pb_lives = ProgressBar(master = self, x = 500, y = 50, w = 240, h = 50, color_background = None, color_border = None, 
                                    image_background = "halloween_nigth/recursos/objetos_pantalla/boton.jpeg", 
                                    image_progress = "halloween_nigth/recursos/objetos_pantalla/boton.jpeg", 
                                    value = 5, value_max = 5)
        ...
        self.static_background = Background(x = 0, y = 0, width = w, height = h, 
                                            path = "halloween_nigth/recursos/menu/pngegg.png")

        self.player_1 = Player(x = 0, y = 400, speed_walk = 6, speed_run = 12, gravity = 14, jump_power = 30,
                               frame_rate_ms = 100, move_rate_ms = 50, jump_height = 140, p_scale = 0.2,
                               interval_time_jump = 300)

        self.enemy_list = []
        self.enemy_list.append (Enemy(x = 450, y = 400, speed_walk = 6, speed_run = 5, gravity = 14, jump_power = 30,
                                      frame_rate_ms = 150, move_rate_ms = 50, jump_height = 140, p_scale = 0.08,
                                      interval_time_jump = 300))
